...
const transcriptSeed: TranscriptItem[] = [
  {
    ...
    speaker: "agent",
    time: "10:21:03",
    text: "안녕하세요. 신한라이프 고객센터 상담사 이서연입니다. 본인 확인 후 상담 도와드리겠습니다.",
  },
  {
    id: "stt-2",
    speaker: "customer",
...
const productCandidates = ["신한라이프 실손의료비 보장", "보험금 청구 서비스", "모바일 추가서류 제출"]
...
export function CounselingSummaryTool() {
  ...
  const [smsDraft, setSmsDraft] = useState(
    [
      ...
      "해당 서류는 병원 원무과에서 발급받으신 뒤, 신한라이프 모바일 앱 또는 홈페이지의 추가서류 제출 메뉴에서 업로드하실 수 있습니다.",
  ...
  const [agentSummary, setAgentSummary] = useState(
    [
      ...
      "추가 서류는 병원 원무과에서 발급 가능하며, 신한라이프 모바일 앱 또는 홈페이지의 추가 서류 제출 메뉴로 업로드할 수 있다고 설명했습니다.",
      ...
      <Card className="py-0">
        ...
        <CardContent className="space-y-4 p-6 text-sm">
          <div className="rounded-xl border border-[#c7ddf4] bg-[#f2f8ff] p-5">
            ...
            <div className="mt-1 font-bold text-[#10233f]">신한라이프 실손의료비 보장</div>
