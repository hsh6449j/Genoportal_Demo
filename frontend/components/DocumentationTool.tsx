...
const DEMO_SCENARIOS: DemoScenario[] = [
  ...
  },
  {
    ...
    form: {
      requestTitle: "신한라이프 생성형 AI 도입 제안요청서 초안",
  ...
  },
  {
    ...
    form: {
      ...
      quote: "신한라이프는 상담 현장과 내부 업무 전반에서 바로 활용 가능한 AI 서비스를 단계적으로 확대해 나갈 계획입니다.",
