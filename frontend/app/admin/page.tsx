...
const serviceUsageRows = [
  { service: "고객상담 어시스턴트", calls: 1842, users: 126, tokens: "3.8M", success: 94, model: "Qwen3.5" },
...
const recentResponseLogs = [
  { time: "15:12:08", user: "이서연", service: "고객상담 어시스턴트", requestId: "REQ-260519-1208", endpoint: "/api/consulting/stt-summary", status: "성공", duration: "1.4초", summary: "상담 STT 요약 생성 완료", detail: "상담사/고객 발화를 분리해 상담 요약과 핵심 키워드를 생성했습니다.", response: "요약 1건, 키워드 5건, 관련 상품 2건 반환" },
  ...
  { time: "15:16:03", user: "이서연", service: "고객상담 어시스턴트", requestId: "REQ-260519-1603", endpoint: "/api/consulting/realtime-analysis", status: "재시도", duration: "2.1초", summary: "실시간 분석 요청 재시도 후 성공", detail: "초기 요청에서 일시 타임아웃이 발생했으나 자동 재시도 후 정상 처리되었습니다.", response: "고객 의도 후보 3건, 다음 안내 후보 1건 반환" },
...
function QualityMonitoringView({ seed }: { seed: number }) {
  ...
  const rows = [
    { service: "고객상담 어시스턴트", accuracy: "94%", hallucination: "1.8%", latency: "1.9초", feedback: "89%", level: "정상" as HealthLevel },
